...
immune_dif <- read.table('Immune_infil_difference_df.txt',header=T,sep='\t')
immune_dif$lgp <- -log10(immune_dif[,'Pvalue'])
immune_cells <- immune_dif[,'Immune_cell']
pdf('/home/shengli/projects/AEG_proteomics/figures/RNAseq/Immune_infil_diff.pdf',width=9.5,height=3.5)
...
immune_prof <- t(immune_prof)
immune_samples <- immune_prof['Sample',]
...
colnames(immune_prof) <- immune_prof['Sample',]
cell <- c('Macrophages.M2')
...
pdf('/home/shengli/projects/AEG_proteomics/figures/Proteomics/Macrophage_M2_comparison_3subtypes.pdf',height=5,width=6)
